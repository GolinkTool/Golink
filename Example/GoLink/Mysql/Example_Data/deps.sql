...
CREATE TABLE `deps` (
  ...
  `package_name_id` int DEFAULT NULL,
  `package_version_id` int DEFAULT NULL,
  `dep_name_id` int DEFAULT NULL,
  `dep_version_list` text,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2025-03-22  6:56:33
